<button
	...
	id="stream-play"
	data-loading-text="{{{ trans("stream.loading") }}}">
...
<div class="btn-group btn-block" style="width:100%">
	...
	<ul class="dropdown-menu" role="menu" style="width: 100%">
		<li>
			<a href="https://stream.r-a-d.io/main.mp3">{{{ trans("stream.links.direct") }}}</a>
		</li>
		
		<li>
			<a href="/assets/main.mp3.m3u">{{{ trans("stream.links.m3u") }}}</a>
		</li>

		<li>
			<a href="/assets/main.pls">{{{ trans("stream.links.pls") }}}</a>
		</li>
		...
		<li>
			<a href="#help" data-toggle="modal" data-target="#help">{{{ trans("stream.links.help") }}}</a>
		</li>
	</ul>
</div>
